---
name: chatgpt-ads-copywriter
description: Writes ChatGPT Ads copy for real estate agents — context hints, keyword arrays, ad titles (24 char max), ad descriptions (48 char max), and image-to-ad pairing rationale. Use this skill whenever the agent needs to write ChatGPT Ads content. Loads marketing-psychology for persuasion craft. References the 25-moment library in reference/moments.md to select and customize ad group targeting. Enforces strict character limits, Fair Housing compliance, and the user's voice from market-config.md.
---
...
2. **Read `reference/moments.md`** to pull the right moment(s) for the ad group(s) you're writing.
...
Pull the matching moment from `reference/moments.md` as your starting point. Then customize it:
